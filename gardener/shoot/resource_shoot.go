...
import (
	...
	metadata "github.com/kyma-incubator/terraform-provider-gardener/gardener/metadata"
	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"metadata": &schema.Schema{
				...
				Required:    true,
				MaxItems:    1,
				Elem:        metadata.MetadataResource("shoot"),
			},
			"spec": &schema.Schema{
				Type:        schema.TypeList,
...
func resourceServerCreate(d *schema.ResourceData, m interface{}) error {
	client := m.(*lib.Client)
	metadata := metadata.ExpandMetadata(d.Get("metadata").([]interface{}))
	...
	d.SetId(lib.BuildID(shoot.ObjectMeta))
...
func resourceServerRead(d *schema.ResourceData, m interface{}) error {
	client := m.(*lib.Client)
	namespace, name, err := lib.IdParts(d.Id())
	if err != nil {
		return err
	}
	...
	err = d.Set("metadata", metadata.FlattenMetadata(shoot.ObjectMeta))
	if err != nil {
		return err
	}
	err = d.Set("spec", FlattenShoot(&shoot.Spec))
	if err != nil {
		return err
	}
	return nil
...
func resourceServerUpdate(d *schema.ResourceData, m interface{}) error {
	...
	newShoot := gardencorev1beta1.Shoot{
		ObjectMeta: metadata.ExpandMetadata(d.Get("metadata").([]interface{})),
		Spec:       *ExpandShoot(d.Get("spec").([]interface{})),
		TypeMeta: meta_v1.TypeMeta{
			Kind:       "Shoot",
			APIVersion: "core.gardener.cloud/v1beta1",
